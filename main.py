...
import numpy as np
import os
from Camera_Calibration.homography import get_homography
from Camera_Calibration.intrinsics import get_intrinsics_param
from Camera_Calibration.extrinsics import get_extrinsics_param
from Camera_Calibration.distortion import get_distortion
from Camera_Calibration.refine_all import refinall_all_param
...
if __name__ == "__main__":
    file_dir = r'../Camera_Calibration/pic'
    # 标定所用图像
